...
\begin{itemize}
  \item Work with customers and engineers to improve Endless OS, a Linux-based operating system designed for people with little or no Internet connection
  \item Utilize Flatpak, OSTree, and GNOME technologies to develop Endless OS
\end{itemize}
