...
\begin{itemize}
  \item Proficient in using linux, git, bash, vim, gdb, valgrind, and autotools
  \item Significant experience in Linux desktop technologies: Flatpak, GLib, GObject, etc.
