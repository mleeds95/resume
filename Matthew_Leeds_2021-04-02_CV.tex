...
\begin{itemize}
  \item Implemented the support for offline updates in Flatpak, with initial work by Philip Withnall
...
\begin{itemize}
  \item Maintained Endless OS, a Linux distribution designed for users with limited computer experience and Internet connections
